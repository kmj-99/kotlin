...
val normalizeComponentsXmlEndings by tasks.registering {
    ...
    val outputDirectory = layout.buildDirectory.get().asFile.resolve(name)
...
val proguard by task<CacheableProguardTask> {
    ...
    outjars(fileFrom(layout.buildDirectory.get().asFile, "libs", "$jarBaseName-$version-after-proguard.jar"))
