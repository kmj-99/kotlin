...
internal class KonanPartialModuleDeserializer(
    ...
    fun getFileNameOf(declaration: org.jetbrains.kotlin.ir.declarations.IrDeclaration): String {
        fun org.jetbrains.kotlin.ir.declarations.IrDeclaration.getSignature() = symbol.signature ?: descriptorSignatures[descriptor]

        val idSig = declaration.getSignature()
                ?: (declaration.parent as? org.jetbrains.kotlin.ir.declarations.IrDeclaration)?.getSignature()
                ?: ((declaration as? IrAttributeContainer)?.attributeOwnerId as? org.jetbrains.kotlin.ir.declarations.IrDeclaration)?.getSignature()
