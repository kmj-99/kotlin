...
object FirJvmStaticChecker : FirBasicDeclarationChecker() {
    override fun check(declaration: FirDeclaration, context: CheckerContext, reporter: DiagnosticReporter) {
        ...
        val declarationAnnotation = declaration.findAnnotation(JvmStandardClassIds.Annotations.JvmStatic)
    ...
    private fun checkStaticOnConstOrJvmField(
        ...
        if (declaration.isConst || declaration.backingField?.hasAnnotationNamedAs(JvmStandardClassIds.Annotations.JvmField) == true) {
