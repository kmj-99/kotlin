...
import org.jetbrains.kotlin.fir.analysis.diagnostics.FirErrors.EXPECT_ACTUAL_DEPRECATION_LEVEL
...
//            map.put(ILLEGAL_PROJECTION_USAGE, ...) // &
        ...
        map.put(EXPECT_ACTUAL_DEPRECATION_LEVEL, "Actual declaration cannot have a stricter deprecation level than the expected declaration. {0}.", TO_STRING)
        map.put(
