...
class IdSignatureSerializer(
    ...
    private val protoIdSignatureArray: ArrayList<org.jetbrains.kotlin.backend.common.serialization.proto.IdSignature>
) {
    ...
    private fun serializePublicSignature(signature: IdSignature.CommonSignature): ProtoCommonIdSignature {
        ...
        serializeDebugInfo?.let { serializeDebugInfo ->
    ...
    private fun serializeIdSignature(idSignature: IdSignature): ProtoIdSignature {
        val proto = org.jetbrains.kotlin.backend.common.serialization.proto.IdSignature.newBuilder()
        when (idSignature) {
